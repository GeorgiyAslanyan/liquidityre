    ...
    <div className='relative mb-4 sm:mb-10 p-7 overflow-hidden rounded-[30px] border border-secondary bg-moduleDark flex justify-between gap-32 flex-col'>
        ...
        <div className='flex justify-between gap-10'>
            <div className='flex flex-col xl:flex-row gap-10 xl:gap-32 items-start w-full'>
                ...
                <Image src="/navbar/logo.svg" alt="logo" width={180} height={33} className='hidden lg:flex'/>
                <Image src="/navbar/logoShort.svg" alt="logo" width={33} height={33} className='flex lg:hidden'/>
        ...
        <div>
            ...
            <div className='flex flex-wrap justify-between text-subtextDark text-sm'>
                <p>©2024 ZeroXLabs</p>
